...
DB_FETCH_BATCH_SIZE = 1_000
DB_QUERIER_CONCURRENT_THREADS = 2
...
KAFKA_REQUEST_TIMEOUT_SECS = 30
KAFKA_OAUTH_CB_POLL_TIMEOUT = 3
KAFKA_FULL_FLUSH_TIMEOUT_SECS = 30
KAFKA_CONFIG_RELOAD_DELAY_SECS = 1

# General

MESSAGE_KEY_FIELD_NAME_WHEN_PK_ABSENT = '_row_hash'
DEFAULT_KEY_SCHEMA_COMPATIBILITY_LEVEL: Literal["NONE", "FULL", "FORWARD", "BACKWARD"] = 'FULL'
DEFAULT_VALUE_SCHEMA_COMPATIBILITY_LEVEL: Literal["NONE", "FULL", "FORWARD", "BACKWARD"] = 'FORWARD'
